...
@WebServlet("/gameInvite/await")
public class AwaitServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("AwaitServlet: handling request");
        ...
        IResponse response = inviteManager.handleAwaitRequest(user);
